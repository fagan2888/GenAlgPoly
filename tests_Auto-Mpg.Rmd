...
report <- make.report(my.data, population=300, iterations=50, lambda=0.8)

# See Results

save(report, file="Auto-Mpg300.Rda") # recover with load("Auto-Mpg300.Rda") 
...
write.table(df, "Auto-Mpg300.txt")
