...
filename <- "Cal-Housing/cal_housing"  # where is the data (under dataset folder)
...
save(report, file="Cal-Housing250.Rda") # recover with load("Cal-Housing250.Rda") 
...
write.table(df, "Cal-Housing250.txt")
# df <- read.table("Cal-Housing250.txt")
...
qplot(method,error,data=df,geom=c("jitter","boxplot")) + 
  ...
  ggtitle("California Housing dataset")
