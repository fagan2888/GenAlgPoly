...
\begin{axis}[width=\textwidth,height=6cm,
	...
	\addplot[only marks, mark=o,color=black] table [x expr=1+0.2*rand,y index=0] {data/lambda.errors.Auto-Mpg.dat};
	\addplot[only marks, mark=o,color=black] table [x expr=2+0.2*rand,y index=1] {data/lambda.errors.Auto-Mpg.dat};		
	\addplot[only marks, mark=o,color=black] table [x expr=3+0.2*rand,y index=2] {data/lambda.errors.Auto-Mpg.dat};
	\addplot[only marks, mark=o,color=black] table [x expr=4+0.2*rand,y index=3] {data/lambda.errors.Auto-Mpg.dat};
	\addplot[only marks, mark=o,color=black] table [x expr=5+0.2*rand,y index=4] {data/lambda.errors.Auto-Mpg.dat};
	\addplot[only marks, mark=o,color=black] table [x expr=6+0.2*rand,y index=5] {data/lambda.errors.Auto-Mpg.dat};
	\addplot[only marks, mark=o,color=black] table [x expr=7+0.2*rand,y index=6] {data/lambda.errors.Auto-Mpg.dat};
	\addplot[only marks, mark=o,color=black] table [x expr=8+0.2*rand,y index=7] {data/lambda.errors.Auto-Mpg.dat};
	\addplot[only marks, mark=o,color=black] table [x expr=9+0.2*rand,y index=8] {data/lambda.errors.Auto-Mpg.dat};
	\addplot[only marks, mark=o,color=black] table [x expr=10+0.2*rand,y index=9] {data/lambda.errors.Auto-Mpg.dat};
	\addplot[only marks, mark=o,color=black] table [x expr=11+0.2*rand,y index=10] {data/lambda.errors.Auto-Mpg.dat};
	\addplot[only marks, mark=o,color=black] table [x expr=12+0.2*rand,y index=11] {data/lambda.errors.Auto-Mpg.dat};
	\addplot[only marks, mark=o,color=black] table [x expr=13+0.2*rand,y index=12] {data/lambda.errors.Auto-Mpg.dat};
