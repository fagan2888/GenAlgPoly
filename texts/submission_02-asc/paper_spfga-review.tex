...
Of the regression methods considered \ac{SVM} achieves the best results in 3 out of 4 datasets. However \ac{SVM} and Conditional Inference Trees are pre-trained, with parameters tuned for each particular dataset unlike \ac{EPRR}. Even so it is the best estimator for the \textsc{Abalone} dataset and in the remaining datasets it outperforms most of the other estimators. 
