...
It turns out that, discarding the computational cost of training, the regression method presented here, \acf{EPRR}, prooves to be quite effective. Indeed, according to the results of common  methods on several real-world datasets it is only systematically out-performed by random forests, an \emph{ensemble} method.
