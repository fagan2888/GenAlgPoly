...
report <- make.report(my.data, population=300, iterations=100, lambda=0.975)

# See Results

save(report, file="Housing300_lambda0.975.Rda") # recover with load("Housing300.Rda") 
...
write.table(df, "Housing300_lambda0.975.txt")
