...
source("gapolyfuncs.R")
report <- test.regularization(my.data, population=300, iterations=100, lambda=0.8, runs=25)

save(report, file="Housing300_lambda0.8.vs.no.reg.Rda") # recover with load("Housing300.Rda") 
...
########################################################
# check what attributes Random Forest select has the most importants
