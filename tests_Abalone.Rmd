...
load(file="Abalone300_lambda0.8_add_linears.Rda")
load(file="Abalone300_lambda1_allmonoids.Rda")
...
save(report, file="Abalone300_lambda0.8_add_linears.Rda") # recover with load("Abalone.Rda") 
...
write.table(df, "Abalone300_lambda0.8_add_linears.txt")
...
source("gapolyfuncs.R")
follow.fitness(my.data,population=200,iterations=250,mutation.rate=0.15,lambda=0.8)
