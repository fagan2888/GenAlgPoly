...
report <- make.report(my.data, population=100, iterations=50, mutation.rate=0.15)

summary(report$lm.error)
summary(report$svm.error)
summary(report$rpart.error)
summary(report$citree.error)
...
# Lambda Test
lambda.values <- seq(0.5,2,length.out=20)
n.runs <- 1
