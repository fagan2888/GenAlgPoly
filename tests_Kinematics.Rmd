...
report <- make.report(my.data, population=300, iterations=100, runs=25, lambda=1)

# See Results

save(report, file="Kinematics300_lambda1_allmonoids.Rda") # recover with load("Kinematics.Rda") 
...
write.table(df, "Kinematics300_lambda1_allmonoids.txt")
