...
report <- make.report(my.data, population=300, iterations=300)

# See Results

save(report, file="Kinematics300.Rda") # recover with load("Kinematics.Rda") 
...
write.table(df, "lambda.errors.kinematics.txt")
